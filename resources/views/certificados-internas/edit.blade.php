...
@section('content')
    <div class="card">
        <div class="card-body">
            <form action="{{ route('certificados-internas.update', $voto->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
                ...
                <div class="row mt-4">
                    <div class="col-md-12 text-right">
                        <a href="{{ route('certificados-internas.index') }}" class="btn btn-secondary">
...
<script>
    $(document).ready(function() {
        ...
        function cargarCandidatos() {
            ...
            if (partidoId && cargo) {
                $.get('{{ route('certificados-internas.candidatos') }}', { partido_id: partidoId, cargo: cargo }, function(data) {
